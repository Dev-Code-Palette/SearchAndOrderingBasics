package SearchAndOrdering.English.Sorting.E_ShellSort;


import static SearchAndOrdering.English.Sorting.E_ShellSort.ShellSort.shellSort;
...
public class MainBlock {
    public static void main(String[] args) {
        ...
        System.out.println("After ShellSort -> " + printItemsArray(itemsArray));
    }
